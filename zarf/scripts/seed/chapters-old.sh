...
# chapters
# treat chapters like regular events and store them in postgres
pushd ../../../data/json.gz/
...
## blossom
### treat aggregated files as storage uploads. Events have a max size we'll exceed.
...
# TODO these might be manual entries atm
