...
<div class="flex flex-col sticky top-0 z-10 w-[100%] bg-white">
		...
		<div class="relative flex w-full justify-center pb-2 pt-11 text-base">
			<div class=" w-[300px] flex-col">
				...
				<div class="relative">
					...
					w-full justify-between border-b-2 hover:bg-gray-10"
	...
	<div class="relative">
		<span class="absolute left-0 right-0 h-1 w-full border-b-2 bg-white dark:border-gray-500"
		></span>
	</div>
</div>
