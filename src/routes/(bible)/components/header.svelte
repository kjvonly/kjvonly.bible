...
<div class="flex-column sticky top-0 w-[100%] bg-white">
	<div class="pt-5">
				...
				<div class="mb-2 flex-col">
					<div class="relative w-full flex-1">
						<button onclick={onBookChapterClick}>
							<div class="mt-2 border-b-2 hover:bg-gray-300/75">
						...
						<div
							class="fixed {showBookChapterPopup
								? ''
								: 'hidden'} left-0 right-0 z-10 mx-auto h-[70vh] w-[90vw] bg-white shadow-lg md:w-1/2 md:max-w-screen-sm"
						>
