<script lang="ts">
	...
	let underlineColor = $state(6);
	let textColor = $state(6);
	...
	let fills = [ 'fill-highlighta', 'fill-highlightb', 'fill-highlightc', 'fill-highlightd', 'fill-highlighte', 'fill-neutral-700', ];
